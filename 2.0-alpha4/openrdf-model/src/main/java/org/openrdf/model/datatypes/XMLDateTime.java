 ...
 * - the range of years in this implementation is limited to Integer.MIN_VALUE
 * to Integer.MAX_VALUE for practical reasons
 * - this implementation accepts some dates that have impossible month,
 * day-of-month combinations (such as 2005-02-29, which was not a leap year)
 */
public class XMLDateTime implements Cloneable, Comparable {
	...
	public int compareTo(Object other) {
		...
		XMLDateTime otherDT = (XMLDateTime)other;
