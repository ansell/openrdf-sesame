...
/**
 * A Solution is a representation of a single result of a query, represented as
 * a set of named value bindings. Values are indexed by name of the binding
 * which typically corresponds to the names of the variables used in the
 * projection of the orginal query.
 */
public interface Solution extends Iterable<Binding> {

	/**
	 * Creates an iterator over the bindings in this solution. This only returns
	...
	/**
	 * Gets the binding with the specified name from this solution.
	 * 
	 * @param bindingName
	 *        The name of the binding.
	 * @return The binding with the specified name, or <tt>null</tt> if there
	 *         is no such binding in this solution.
	 */
	public Binding getBinding(String bindingName);

	/**
	 * Checks whether this solution has a binding with the specified name.
	 * 
	 * @param bindingName
	 *        The name of the binding.
	 * @return <tt>true</tt> if this solution has a binding with the specified
	 *         name, <tt>false</tt> otherwise.
	 */
	public boolean hasBinding(String bindingName);

	/**
	 * Gets the value of the binding with the specified name from this solution.
	 * 
	 * @param bindingName
	 *        The name of the binding.
	 * @return The value of the binding with the specified name, or <tt>null</tt>
	 *         if there is no such binding in this solution.
	 */
	...
	/**
	 * Compares a solution object to another object.
	 * 
	 * @param o
	 *        The object to compare this binding to.
	 * @return <tt>true</tt> if the other object is an instance of
	 *         {@link Solution} and it contains the same set of bindings
	 ...
	 * 
	 * @return A hash code for the solution.
	 */
	public int hashCode();
}
