...
public class TriXParser extends RDFParserBase {
	...
	/**
	 * Creates a SimpleSAXAdapter that can be used to parse TRIX when parsing a
	 * bigger XML document, that has TRIX inside. The triples found by this SAX
	 * handler will be reported to the RDFHandler that is regsitered with this
	 * TrixParser.
	 * 
	 * @return a SimpleSAXAdapter that parses TRIX.
	 */
	public SimpleSAXAdapter createSAXHandler() {
		return new TriXSAXHandler();
	} 
