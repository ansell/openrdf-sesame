...
public class MemStatement extends ContextStatementImpl {
	...
	/**
	 * Flag indicating whether or not this statement has been added explicitly
	 * or that it has been inferred.
	 */
	 ...
	 */
	public MemStatement(MemResource subject, MemURI predicate, MemValue object,
		MemResource context)
	{
	 ...
	 */
	public MemStatement(MemResource subject, MemURI predicate, MemValue object,
		MemResource context, boolean explicit)
	{
	...
	public MemResource getContext() {
		MemResource context = getContextInternal();

		if (context instanceof MemNullContext) {
			return null;
		}
		else {
			return context;
	...
	/**
	 * Returns the context object as it is stored in the MemStatement. In cases
	 * where the context belongs to the null context, a {@link MemNullContext}
	 * object is returned. The method {@link #getContext} filters these types of
	 * resources and return <tt>null</tt> instead.
	 */
	public MemResource getContextInternal() {
	 ...
	 * subject, predicate, object and context. The transaction status will be
	 * set to {@link TxnStatus#NEW}.
	 */
	public void addToComponentLists() {
		...
		getContextInternal().addContextStatement(this);
		_txnStatus = TxnStatus.NEW;
	}

	/**
	 * Lets this statement remove itself from the appropriate statement lists of
	 * its subject, predicate, object and context. The transaction status will
	...
	public void removeFromComponentLists() {
		...
		getContextInternal().removeContextStatement(this);
		_txnStatus = null;
	}
}
