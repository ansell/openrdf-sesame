...
public class WeakObjectRegistry<E> extends AbstractSet<E> {
	 ...
	 */
	private Map<E, WeakReference<E>> _objectMap = new WeakHashMap<E, WeakReference<E>>();
	...
	public E get(Object key) {
		WeakReference<E> weakRef = _objectMap.get(key);
	...
	{
		return _objectMap.keySet().iterator();
	}
	...
	{
		WeakReference<E> ref = _objectMap.remove(o);
