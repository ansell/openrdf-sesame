 ...
 * is optional, it can be completely left out of the method call, which is
 * always interpreted as meaning 'operate on the entire repository'. A vararg
 * argument may also be 'null' meaning that the method operates on those
 * statements which have no associated context only.
 * <p>
 * Examples:
 * 
 * <pre>
 * // this method retrieves all statements that appear in either context1 or context2, or both.
 * RepositoryConnection.getStatements(null, null, null, true, context1, context2);
 * 
 * // this method retrieves all statements that appear in the repository (regardless of context).
 * RepositoryConnection.getStatements(null, null, null, true);
 * 
 * // this methods retrieves all statements that have no associated context in the repository
 * RepositoryConnection.getStatements(null, null, null, true, null);
 * </pre>
 * 
