...
import org.openrdf.http.protocol.transaction.operations.ContextStatementOperation;
...
public class TransactionWriter {
		...
		throws IOException
	{
		...
		serialize((ContextStatementOperation)op, xmlWriter);
		...
		throws IOException
	{
		...
		serialize(xmlWriter, op.getContexts());
	...
	private void serialize(ContextStatementOperation op, XMLWriter xmlWriter)
		throws IOException
	{
	...
	private void serialize(XMLWriter xmlWriter, Resource... contexts)
		throws IOException
	{
