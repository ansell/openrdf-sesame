...
public class RepositoryServlet extends GenericServlet {
		...
		throws IOException
	{
		...
		String[] contextParams = request.getParameterValues(CONTEXT_PARAM_NAME);
		...
		try {
			...
			contexts = Protocol.decodeContexts(contextParams, vf);
		}
		...
		throws IOException
	{
		...
		String[] contextParams = request.getParameterValues(Protocol.CONTEXT_PARAM_NAME);
