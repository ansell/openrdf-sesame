...
public abstract class Protocol {
	 ...
	 * @return the URL with the specified parameter appended to it
	 */
	public static final String appendParameter(String url, String parameterName, Value parameterValue) {
		return appendParameter(url, parameterName, encodeValue(parameterValue));
	}
