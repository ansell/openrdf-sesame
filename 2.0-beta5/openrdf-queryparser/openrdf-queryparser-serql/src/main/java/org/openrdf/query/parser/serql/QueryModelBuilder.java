...
class QueryModelBuilder extends ASTVisitorBase {
	...
	public Object visit(ASTFrom node, Object data)
		throws VisitorException
	{
		StatementPattern.Scope scope = StatementPattern.Scope.ALL_CONTEXTS;
		Var contextVar = null;
		...
		throws VisitorException
	{
		...
		graphPattern = graphPattern.getParent();
		graphPattern.addOptionalTE(tupleExpr);
	...
	public ValueConstant buildValueConstant(ASTValue valueNode, Object data)
		throws VisitorException
	{
		Value value = (Value)super.visit(valueNode, data);
	...
	public DatatypeFunc visit(ASTDatatype node, Object data)
		throws VisitorException
	{
		return new DatatypeFunc((ValueExpr)super.visit(node, data));
	}
	...
	public LangFunc visit(ASTLang node, Object data)
		throws VisitorException
	{
		return new LangFunc((ValueExpr)super.visit(node, data));
	}

	@Override
	public LabelFunc visit(ASTLabel node, Object data)
		throws VisitorException
	{
		return new LabelFunc((ValueExpr)super.visit(node, data));
	}

	@Override
	public NamespaceFunc visit(ASTNamespace node, Object data)
		throws VisitorException
	{
		return new NamespaceFunc((ValueExpr)super.visit(node, data));
	}

	@Override
	public LocalNameFunc visit(ASTLocalName node, Object data)
		throws VisitorException
	{
		return new LocalNameFunc((ValueExpr)super.visit(node, data));
	}

	@Override
	public Null visit(ASTNull node, Object data)
		throws VisitorException
	{
		return new Null();
	}
