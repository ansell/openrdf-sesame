...
public class RDFFormat extends FileFormat {
	 ...
	 */
	@Deprecated
	public RDFFormat(String name, String mimeType, String fileExtension, Charset charset)
	{
		this(name, mimeType, charset, fileExtension, false, false);
	}
	 ...
	 * @deprecated Use {@link #getDefaultMIMEType()} instead.
	 */
	@Deprecated
	 ...
	 * 
	 * @return A file name extension (excluding the dot), e.g. "rdf", or
	 *         <tt>null</tt> if there is no common file extension for the
	 *         format.
