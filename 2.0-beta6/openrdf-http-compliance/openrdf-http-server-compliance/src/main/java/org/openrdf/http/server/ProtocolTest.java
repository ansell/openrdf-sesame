...
public class ProtocolTest extends TestCase {
	...
	public void testRepository_PUT()
		throws Exception
	{
		_putFile(Protocol.getStatementsLocation(TestServer.REPOSITORY_URL), "/testcases/default-graph-1.ttl");
	}
	...
	public void testRepository_DELETE()
		throws Exception
	{
		_delete(Protocol.getStatementsLocation(TestServer.REPOSITORY_URL));
	}
		...
		throws Exception
	{
		...
		_putFile(location, "/testcases/default-graph-1.ttl");
	}
		...
		throws Exception
	{
		...
		_putFile(location, "/testcases/named-graph-1.ttl");
	}
	...
	public void testSeRQLselect()
		throws Exception
	{
		TupleQueryResult queryResult = _evaluate(TestServer.REPOSITORY_URL, "select * from {X} P {Y}",
				QueryLanguage.SERQL);
		QueryResultIO.write(queryResult, TupleQueryResultFormat.SPARQL, System.out);
	}

	private void _putFile(String location, String file)
		throws Exception
	{
	...
	private void _delete(String location)
		throws Exception
	{
		URL url = new URL(location);
		HttpURLConnection conn = (HttpURLConnection)url.openConnection();
	...
	private TupleQueryResult _evaluate(String location, String query, QueryLanguage queryLn)
		throws Exception
	{
