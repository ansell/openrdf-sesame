...
class HTTPRepositoryConnection extends RepositoryConnectionBase {
	...
	private List<TransactionOperation> _txn = Collections.synchronizedList(new ArrayList<TransactionOperation>());
	...
	protected void addWithoutCommit(Resource subject, URI predicate, Value object, Resource... contexts)
		throws RepositoryException
	{
		_txn.add(new AddStatementOperation(subject, predicate, object, contexts));
	}
	...
	protected void removeWithoutCommit(Resource subject, URI predicate, Value object, Resource... contexts)
		throws RepositoryException
	{
		_txn.add(new RemoveStatementsOperation(subject, predicate, object, contexts));
	}
	...
	public void clear(Resource... contexts)
		throws RepositoryException
	{
		_txn.add(new ClearOperation(contexts));
		autoCommit();
	}
	...
	public void clearNamespaces()
		throws RepositoryException
	{
		_txn.add(new ClearNamespacesOperation());
		autoCommit();
	}
