...
public class TurtleParserTest {
		...
		throws Exception
	{
		...
		while (queryResult.hasNext()) {
			...
			testName = bindingSet.getValue("testName").toString();
			inputURL = bindingSet.getValue("inputURL").toString();
			outputURL = bindingSet.getValue("outputURL").toString();
	...
	private static class PositiveParserTest extends TestCase {
			...
			throws Exception
		{
			...
			turtleParser.parse(in, _baseURL);
			in.close();
			...
			ntriplesParser.parse(in, _baseURL);
			in.close();
