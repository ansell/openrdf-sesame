...
public class MemoryStore extends SailBase {
	...
	protected static final String PERSISTENT_STORAGE = "memorystore.data";
	...
	protected Lock getQueryReadLock()
		throws SailException
	{
		try {
	...
	protected Lock getQueryWriteLock()
		throws SailException
	{
		try {
	...
	// FIXME: move file I/O code to a separate class
	...
	protected void writeToFile(File dataFile)
	...
	protected void readFromFile(File dataFile)
		throws IOException
	{
