...
/**
 * Additional Manifest-based test cases for SPARQL 1.1 querying (see
 * sesame-sparql-testsuite/src/main/resources/testcases-sparql-1.1)
 *
 * @author Jeen Broekstra
 */
public class SesameExtraSPARQL11QueryTest extends SPARQLQueryTest {
		...
		throws Exception
	{
		return SPARQL11ManifestTest.suite(new Factory() {
			...
			public SesameExtraSPARQL11QueryTest createSPARQLQueryTest(String testURI, String name,
			...
			public SesameExtraSPARQL11QueryTest createSPARQLQueryTest(String testURI, String name,
					...
					boolean checkOrder)
			{
				return new SesameExtraSPARQL11QueryTest(testURI, name, queryFileURL, resultFileURL, dataSet,
						laxCardinality, checkOrder);
			}
		}, false, false, false);
	}

	protected SesameExtraSPARQL11QueryTest(String testURI, String name, String queryFileURL,
