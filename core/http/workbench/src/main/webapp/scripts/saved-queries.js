...
workbench.savedQueries = {
	deleteQuery : function _deleteQuery(savedBy, name, urn) {
...
workbench
		.addLoad(function() {
			...
			for ( var i = 0; i < editForms.length; i++) {
				...
				queryText.setAttribute('value', queryText.getAttribute('value')
						.trim());
			}
		});
