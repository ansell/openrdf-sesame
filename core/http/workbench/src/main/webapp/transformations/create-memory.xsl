			...
			<table class="dataentry">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" id="id"
								name="Repository ID" size="16" value="memory" />
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<input type="text" id="title"
								name="Repository title" size="48" value="Memory Store" />
						</td>
						<td></td>
					</tr>
					<tr>
						<td>
							<xsl:value-of
								select="$repository-persist.label" />
						</td>
						<td>
							<input type="radio" id="persist"
								name="Persist" size="48" value="true" checked="true" />
							<xsl:value-of select="$true.label" />
							<input type="radio" id="persist"
								name="Persist" size="48" value="false" />
					...
					<tr>
						<th>
							<xsl:value-of
								select="$repository-sync-delay.label" />
						</th>
						<td>
							<input type="text" id="delay"
								name="Sync delay" size="4" value="0" />
						</td>
						<td></td>
					</tr>
					<tr>
