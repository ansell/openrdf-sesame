...
public class TransactionWriter {
	...
	public void serialize(Iterable<? extends TransactionOperation> txn, OutputStream out)
		throws IOException
	{
		assert txn != null : "Operation list is null";
		...
		throws IOException
	{
		...
		else if (op instanceof RemoveNamedContextStatementsOperation) {
			serialize((RemoveNamedContextStatementsOperation)op, xmlWriter);
		}
		...
		throws IOException
	{
		...
		serialize(op.getContext(), xmlWriter);
	...
	private void serialize(RemoveNamedContextStatementsOperation op, XMLWriter xmlWriter)
		throws IOException
	{
		xmlWriter.startTag(TransactionXMLConstants.REMOVE_NAMED_CONTEXT_STATEMENTS_TAG);
		serialize(op.getSubject(), xmlWriter);
		serialize(op.getPredicate(), xmlWriter);
		serialize(op.getObject(), xmlWriter);
		serialize(op.getContext(), xmlWriter);
		xmlWriter.endTag(TransactionXMLConstants.REMOVE_NAMED_CONTEXT_STATEMENTS_TAG);
	}
