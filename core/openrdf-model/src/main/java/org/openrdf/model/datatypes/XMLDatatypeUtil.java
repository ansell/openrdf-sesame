...
public class XMLDatatypeUtil {
	 ...
	 */
	public static boolean isDateTimeDatatype(URI datatype) {
	 ...
	 * @throws IllegalArgumentException If the supplied value is illegal
	 * considering the supplied datatype.
	 */
	 ...
	 * @throws IllegalArgumentException If one of the supplied strings is not a
	 * legal decimal.
	 */
	public static String normalizeDecimal(String decimal) {
		decimal = _collapseWhiteSpace(decimal);
	...
	private static String _normalizeIntegerValue(String integer, String minValue, String maxValue) {
		integer = _collapseWhiteSpace(integer);
	...
	*/
	 ...
	 */
	private static String _collapseWhiteSpace(String s) {
	 ...
	 * @throws IllegalArgumentException If one of the supplied strings is not a
	 * legal float or if <tt>NaN</tt> is compared to a float other than
	 * <tt>NaN</tt>.
	 */
	 ...
	 * @throws IllegalArgumentException If one of the supplied strings is not a
	 * legal double or if <tt>NaN</tt> is compared to a double other than
	 * <tt>NaN</tt>.
	 */
	 ...
	 * (&gt;0) if <tt>float1</tt> is larger than <tt>float2</tt>.
	 * @throws IllegalArgumentException If one of the supplied strings is not a
	 * legal floating point number or if <tt>NaN</tt> is compared to a floating
	 * point number other than <tt>NaN</tt>.
	 */
