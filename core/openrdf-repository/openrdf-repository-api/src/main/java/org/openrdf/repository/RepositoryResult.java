...
/**
 * A RepositoryResult is a result set of objects (for example
 ...
 * results. Additionally it can fully consume all objects in the result and
 * return a {@link java.util.Collection} object containing all objects.
 * <p>
 * A RepositoryResult needs to be closed after use to free up any resources
 * (open connections, read locks, etc.) it has on the underlying repository.
 * 
