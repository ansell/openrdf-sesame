...
public class RepositoryUtil {
	 ...
	 * of both repositories into main memory. Use with caution.
	 * 
	 * @deprecated Method has been renamed to
	 *             {@link #equals(Repository, Repository)}.
	 */
	@Deprecated
	public static boolean modelsEqual(Repository rep1, Repository rep2)
		throws RepositoryException
	{
		return equals(rep1, rep2);
	}
	 ...
	 * 
	 * @deprecated Use
	 *             {@link QueryResultUtil#equals(TupleQueryResult, TupleQueryResult)}
	 *             instead.
	...
	public static boolean modelsEqual(TupleQueryResult result1, TupleQueryResult result2)
		throws QueryEvaluationException
	{
		return QueryResultUtil.equals(result1, result2);
	}

	/**
	 * @deprecated Use
	 *             {@link QueryResultUtil#equals(GraphQueryResult, GraphQueryResult)}
	 *             instead.
	 */
	@Deprecated
	 ...
	 * 
	 * @deprecated Use {@link ModelUtil#equals(Iterable, Iterable)} instead.
	 */
	@Deprecated
	 ...
	 * 
	 * @deprecated Use {@link ModelUtil#isSubset(Iterable, Iterable)} instad.
	 */
	@Deprecated
	 ...
	 * 
	 * @deprecated Use {@link DAWGTestResultSetUtil#toGraph(TupleQueryResult)}
	 *             instead.
	 */
	@Deprecated
	public static Graph asGraph(TupleQueryResult tqr)
		throws QueryEvaluationException
	{
		return DAWGTestResultSetUtil.toGraph(tqr);
	}

	/**
	 * @deprecated Use <tt>new GraphImpl(Iterations.asSet(gqr))</tt> instead.
	 */
	@Deprecated
	public static Graph asGraph(GraphQueryResult gqr)
		throws QueryEvaluationException
	{
		Set<Statement> uniqueStatements = Iterations.asSet(gqr);
		return new GraphImpl(uniqueStatements);
	}
}
