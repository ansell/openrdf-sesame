 ...
 */
class SailBooleanQuery extends SailQuery implements BooleanQuery {

	public SailBooleanQuery(ParsedBooleanQuery tupleQuery, SailRepositoryConnection sailConnection) {
