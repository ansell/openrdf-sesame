...
class SailGraphQuery extends AbstractQuery implements GraphQuery {
		...
		throws QueryEvaluationException
	{
		...
		try {
			...
			CloseableIteration<Statement, QueryEvaluationException> stIter = new ConvertingIteration<BindingSet, Statement, QueryEvaluationException>(bindingsIter) {
			...
			return new SailGraphQueryResult(_graphQuery.getQueryNamespaces(), stIter);
		}
