 ...
 * 
 * <pre>
 * Repository repository = new RepositoryImpl(new MemoryStoreRDFSInferencer(new MemoryStore()));
...
public class SailRepository implements Repository {
	...
	public File getDataDir() {
		return _sail.getDataDir();
	}

	public void setDataDir(File dataDir) {
		_sail.setDataDir(dataDir);
	}
	...
	{
		try {
			return new SailRepositoryConnection(this, _sail.getConnection());
		}
		catch (SailException e) {
			throw new RepositoryException(e);
		}
