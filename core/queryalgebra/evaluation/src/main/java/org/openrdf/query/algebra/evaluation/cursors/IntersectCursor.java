...
/**
 * A cursor that returns the intersection of the results of two cursors.
 * Optionally, the cursor can be configured to filter duplicates from the
 * returned elements.
 * <p>
...
public class IntersectCursor<E> extends FilteringCursor<E> {
	...
	/**
	 * Creates a new IntersectCursor that returns the intersection of the
	 * results of two cursors. By default, duplicates are <em>not</em>
	 * filtered from the results.
	 * 
	 * @param arg1
	 *        A cursor containing the first set of elements.
	 * @param arg2
	 *        A cursor containing the second set of elements.
	 */
