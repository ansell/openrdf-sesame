...
/**
 * The {@link FederatedServiceManagerImpl} is used to manage a set of
 ...
 * @author James Leigh
 */
public class FederatedServiceManagerImpl extends FederatedServiceManager {

	public FederatedServiceManagerImpl() {
		;
	}
