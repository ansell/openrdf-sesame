...
public class StrAfterTest {
	...
	public void testEvaluate6() {
		...
		try {
			...
			assertEquals("incompatible operands for STRAFTER: \"10\"^^<http://www.w3.org/2001/XMLSchema#int>, \"b\"^^<http://www.w3.org/2001/XMLSchema#string>", e.getMessage());
		}
	}
	...
	public void testEvaluate7() {
		...
		try {
			...
			assertEquals("incompatible operands for STRAFTER: http://example.org/foobar, \"b\"^^<http://www.w3.org/2001/XMLSchema#string>", e.getMessage());
		}
	}
	...
	public void testEvaluate9() {
		...
		try {
			...
			assertEquals("incompatible operands for STRAFTER: \"foobar\"^^<http://www.w3.org/2001/XMLSchema#string>, \"b\"@nl", e.getMessage());
		}
	}
