...
/**
 * The GeoSPARQL {@link Function} geof:sfDisjoint, as defined in <a
 * href="http://www.opengeospatial.org/standards/geosparql">OGC GeoSPARQL - A
 * Geographic Query Language for RDF Data</a>.
 */
public class SfDisjoint extends GeometricRelationFunction {

	@Override
	public String getURI() {
		return GEOF.SF_DISJOINT.stringValue();
	}

	@Override
	protected boolean relation(Shape s1, Shape s2) {
		return SpatialSupport.getSpatialAlgebra().sfDisjoint(s1, s2);
	}
}
