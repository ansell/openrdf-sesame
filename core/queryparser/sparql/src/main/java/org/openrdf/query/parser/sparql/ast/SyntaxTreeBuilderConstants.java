...
public interface SyntaxTreeBuilderConstants {
  ...
  int SAFE_CHAR2 = 166;
  /** RegularExpression Id. */
  int SAFE_CHAR_LONG1 = 167;
  /** RegularExpression Id. */
  int SAFE_CHAR_LONG2 = 168;
  /** RegularExpression Id. */
  int ECHAR = 169;
  /** RegularExpression Id. */
  int HEX = 170;
  ...
  int NUM = 172;
  /** RegularExpression Id. */
  int PN_CHARS_BASE = 173;
  /** RegularExpression Id. */
  int PN_CHARS_U = 174;
  /** RegularExpression Id. */
  int PN_START_CHAR = 175;
  /** RegularExpression Id. */
  int VAR_CHAR = 176;
  /** RegularExpression Id. */
  int PN_END_CHAR = 177;
