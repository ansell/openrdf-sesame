...
public interface SyntaxTreeBuilderConstants {
  ...
  int SAFE_CHAR2 = 101;
  /** RegularExpression Id. */
  int SAFE_CHAR_LONG1 = 102;
  /** RegularExpression Id. */
  int SAFE_CHAR_LONG2 = 103;
  /** RegularExpression Id. */
  int ECHAR = 104;
  /** RegularExpression Id. */
  int HEX = 105;
  ...
  int NUM = 107;
  /** RegularExpression Id. */
  int PN_CHARS_BASE = 108;
  /** RegularExpression Id. */
  int PN_CHARS_U = 109;
  /** RegularExpression Id. */
  int PN_START_CHAR = 110;
  /** RegularExpression Id. */
  int VAR_CHAR = 111;
  /** RegularExpression Id. */
  int PN_END_CHAR = 112;
