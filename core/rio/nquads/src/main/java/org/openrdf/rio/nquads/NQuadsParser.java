...
/**
 * RDF parser implementation for the {@link RDFFormat#NQUADS N-Quads} RDF format, extending the Rio
 * N-Triples parser. A specification of N-Quads can be found <a
 * href="http://sw.deri.org/2008/07/n-quads/">here</a>. This parser is not thread-safe, therefore
...
public class NQuadsParser extends NTriplesParser
{
    ...
    @Override
    public synchronized void parse(final InputStream inputStream, final String baseURI) throws IOException,
    ...
    @Override
    public synchronized void parse(final Reader reader, final String baseURI) throws IOException, RDFParseException,
        RDFHandlerException
    {
        if(reader == null)
        {
