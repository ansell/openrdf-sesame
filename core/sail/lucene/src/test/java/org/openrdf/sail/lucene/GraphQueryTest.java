...
/**
 * This test verifies why the LuceneSailTest.testGraphQuery() test fails with
 * LuceneSail using Sesame >= 2.1. LuceneSail bases on a feature that was
 * removed with Sesame 2.1. That feature is exploited here. This test succeeds
 * with Sesame < 2.1. However, LuceneSail works fine, except such GraphQueries.
 * If you need them to work properly, use the sesame-2.0 branch of LuceneSail.
 * See https://dev.nepomuk.semanticdesktop.org/wiki/LuceneSailGraphQueries
