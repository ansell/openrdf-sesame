...
public class PgSqlSparqlTest extends SPARQLQueryTest {
	...
	public static class Factory extends SPARQLQueryTest.Factory {
		...
		public SPARQLQueryTest createSPARQLQueryTest(String testURI,
				...
				Dataset dataSet) {
			return new PgSqlSparqlTest(testURI, name, queryFileURL,
					resultFileURL, dataSet);
		}
	}

	public static TestSuite suite() throws Exception {
		return ManifestTest.suite(new PgSqlSparqlTest.Factory());
	}

	public PgSqlSparqlTest(String testURI, String name, String queryFileURL,
	...
	protected Repository createRepository() throws RepositoryException {
		...
		Sail sail = new PgSqlStore("sesame-test");
