...
//		for (IdCode code : IdCode.values()) {
////			assertEquals(code, IdSequence.valueOf(code.minId()));
////			assertEquals(code, IdSequence.valueOf(code.minId() + 1));
////			assertEquals(code, IdSequence.valueOf(code.maxId()));
////			assertEquals(code, IdSequence.valueOf(code.maxId() - 1));
//		}
//	}
//
...
//		for (IdCode code : IdCode.values()) {
////			assertEquals(code, IdSequence.valueOf(code.hash(new URIImpl("urn:root"))));
////			assertEquals(code, IdSequence.valueOf(code.hash(new URIImpl("urn:The quick brown fox jumps over the lazy dog"))));
//		}
//	}
//
