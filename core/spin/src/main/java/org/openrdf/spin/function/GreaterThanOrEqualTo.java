...
public class GreaterThanOrEqualTo extends BinaryFunction {

	@Override
	public String getURI() {
		return SP.GE.toString();
	}
	...
	{
		return BooleanLiteralImpl.valueOf(QueryEvaluationUtil.compare(arg1, arg2, CompareOp.GE));
	}
}
