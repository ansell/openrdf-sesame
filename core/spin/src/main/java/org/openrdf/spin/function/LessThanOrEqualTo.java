...
public class LessThanOrEqualTo extends BinaryFunction {

	@Override
	public String getURI() {
		return SP.LE.toString();
	}
	...
	{
		return BooleanLiteralImpl.valueOf(QueryEvaluationUtil.compare(arg1, arg2, CompareOp.LE));
	}
}
