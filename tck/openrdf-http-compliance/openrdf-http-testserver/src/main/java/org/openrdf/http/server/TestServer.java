...
import org.openrdf.sail.memory.config.MemoryStoreRDFSInferencerConfig;
...
public class TestServer extends EmbeddedServer {
	...
	public static String INFERENCE_REPOSITORY_URL = Protocol.getRepositoryLocation(TestServer.SERVER_URL, TEST_INFERENCE_REPO_ID);
		...
		throws RepositoryException, RepositoryConfigException
	{
		...
		MemoryStoreRDFSInferencerConfig inferMemStoreConfig = new MemoryStoreRDFSInferencerConfig(
