...
public class SailIsolationLevelTest {
	...
	protected long count(RepositoryConnection con, Resource subj, URI pred, Value obj, boolean includeInferred,
			Resource... contexts)
		throws RepositoryException
	{
	...
	protected Literal readLiteral(RepositoryConnection con, final URI subj, final URI pred)
		throws RepositoryException
	{
		CloseableIteration<? extends Statement, RepositoryException> stmts;
